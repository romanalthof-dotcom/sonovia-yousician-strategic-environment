#!/usr/bin/env python3
"""Create the v3.2.3 board-readiness gate files.
...
def open_review_count(rows: list[dict[str, str]]) -> int:
    return len(source_review_rows(rows))
...
def main() -> None:
    ...
    refresh_retries = len(refresh_retry_rows(review_queue))
    ...
    readiness_rows = [
        {
            ...
            "safe_language": "Use as an executive ecosystem map with explicit validation gates.",
            ...
            "evidence_anchor": "v3.4 handoff package",
            "source_url": "",
        ...
        },
        {
            ...
            "safe_language": f"{len(app_req)} app rows are ready for Appfigures export; {len(credentialed_rows)} credentialed rows are currently populated.",
        ...
        },
        {
            ...
            "safe_language": f"{len(relationships)} relationship rows are prepared for internal completion.",
            ...
            "owner_placeholder": "Yousician relationship owners",
        ...
        },
        {
            ...
            "safe_language": f"{len(hard_claims)} hard claims are mapped to source/review action rows.",
        ...
        },
        {
            ...
            "safe_language": f"{open_reviews} source-change review items and {refresh_retries} refresh retry/access rows remain surfaced and are not automatically promoted into final claims.",
        ...
        },
        {
            ...
            "safe_language": f"{len(influencers)} creator rows exist; {len(creator_pending)} rows still need TikTok/Instagram or average-view validation.",
        ...
        },
        {
            ...
            "safe_language": f"{len(board_moves)} curated news-grade moves are in the board timeline; static context remains in appendix data.",
            ...
            "next_action": "Use Grade A/B news in slides; leave Grade C context in appendix.",
        ...
        },
        {
            ...
            "safe_language": f"{len(awards)} award rows and {len(funding)} funding rows are operationalized with fit, effort and next action fields.",
    ...
    write_csv("board_readiness_gate_v3_4.csv", readiness_rows, readiness_fields)

    summary_rows = [
        {
            "readiness_bucket": "Ready to discuss",
            "meaning_for_recipient": "The package can be opened as an executive ecosystem discussion artifact.",
        ...
        },
        {
            ...
            "meaning_for_recipient": "Hard claims are traceable but still require a final claim/source skim before being quoted externally.",
        ...
        },
        {
            ...
            "meaning_for_recipient": "Appfigures performance and internal relationship claims cannot be finalized from public research alone.",
    ...
    write_csv(
        "executive_send_readiness_summary_v3_4.csv",
        summary_rows,
        [
            "readiness_bucket",
            "meaning_for_recipient",
            "included_artifacts",
            "safe_words",
            "avoid_words",
            "owner_placeholder",
    ...
    layout_rows = [
        ...
        },
        {
            ...
            "qa_artifact": "executive_summary_deck_contact_sheet_v3.4.png",
    ...
    print("Wrote board readiness gate v3.2.3 files.")
