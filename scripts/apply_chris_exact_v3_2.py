#!/usr/bin/env python3
"""Add Chris-exact v3.2 layers on top of the v3.1 living package."""
        ...
        request_pack.append(
            {
                ...
                "why_needed_for_chris": "Required to compare app-based company scale, growth, geography and monetization without using unverifiable proxies.",
...
def generate_live_overrides(app_rows: list[dict[str, object]]) -> dict[str, object]:
    ...
    data = {
        "status": {
            ...
            "lastUpdated": TODAY,
            "source": "scripts/apply_chris_exact_v3_2.py",
...
def write_status_files() -> None:
    ...
    write_csv(HANDOFF / "chris_exact_status_v3_2.csv", rows)
