#!/usr/bin/env python3
"""Add the final executive prioritization layer on top of v3.2 handoff data."""
...
def main() -> None:
    ...
    decision_gates = [
        {
            ...
            "why_it_matters_for_the_brief": "The brief explicitly asks for Appfigures where possible; without it, app-based success cannot be ranked by revenue, downloads, ranks, review velocity or country mix.",
            ...
            "decision_needed": "Export now, accept caveat, or remove performance ranking from executive-facing claims.",
        ...
        },
        {
            ...
            "why_it_matters_for_the_brief": "Relationship fields are part of the brief, but external research cannot infer relationship status safely.",
        ...
        },
        {
            ...
            "why_it_matters_for_the_brief": "Influencers and creator educators are named in the brief; names alone are not enough for a strategic layer.",
        ...
        },
        {
            ...
            "why_it_matters_for_the_brief": "Ownership, investors and funding are high-risk claims if based only on incomplete public pages.",
        ...
        },
        {
            ...
            "why_it_matters_for_the_brief": "The tracker is only useful if someone can decide submit, monitor or deprioritize.",
        ...
        },
        {
            ...
            "why_it_matters_for_the_brief": "A living database can refresh, but executive-/Board-facing claims should not update automatically without review.",
    ...
    write_csv("executive_top_10_actor_ranked_v3_4.csv", top_actors, fields_actor)
    write_csv("ecosystem_map_2_0_v3_2_2.csv", ecosystem_layers, fields_ecosystem)
    write_csv("executive_decision_gates_v3_4.csv", decision_gates, fields_gate)
    write_csv("executive_story_spine_v3_4.csv", story_spine, fields_spine)

    print(f"Wrote executive final polish v3.2.2 files on {TODAY}")
